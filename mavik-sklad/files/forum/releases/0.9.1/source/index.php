...
<aside>
  <div class="panel welcome-panel"><h3>Ласкаво просимо!</h3><p>Приєднуйтесь до спільноти, щоб брати участь в обговореннях, ділитися думками та знаходити однодумців.</p><?php if(is_logged_in()): ?><a class="btn primary block" href="/new-topic.php">Створити тему</a><?php else: ?><a class="btn primary block" href="/auth.php?mode=register">Зареєструватися</a><p class="welcome-login">Вже маєте акаунт? <a href="/auth.php">Увійти</a></p><?php endif; ?></div>
  ...
  <div class="panel"><h3><span class="heading-icon"><svg viewBox="0 0 24 24"><path d="M3 3h8l10 10-8 8L3 11z"/><circle cx="7" cy="7" r="1"/></svg></span>Популярні теги</h3><div class="tags"><span>#книги</span><span>#українська_література</span><span>#поезія</span><span>#музика</span><span>#читання</span><span>#рекомендації</span><span>#есе</span><span>#дискусія</span></div></div>
</aside>
</div>
<?php forum_footer(); ?>
