...
function forum_ad_config(): array {
 $defaults=['mode'=>'own','size'=>'300x600','image'=>'https://forum.mavik.name/assets/ads/universe.png','url'=>'https://mavik.name/books/universe/','alt'=>'UNIVERSE — Віктор Макарчук, MaVik','client'=>'','slot'=>'','home'=>true,'composer'=>true];
