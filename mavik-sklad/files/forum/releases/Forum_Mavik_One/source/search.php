...
if($q!==''){
    ...
    $pdo=db();$fold=static fn($s)=>mb_strtolower((string)$s,'UTF-8');
    if(method_exists($pdo,'createFunction'))$pdo->createFunction('forum_fold',$fold,1);else $pdo->sqliteCreateFunction('forum_fold',$fold,1);
