...
<?php foreach($topics as $t): ?>
  <a class="category-topic-row" href="/topic.php?slug=<?=urlencode($t['slug'])?>">
    <div class="category-topic-summary"><?=avatar($t['avatar_path'],$t['display_name']??'Автор')?><div class="category-topic-copy">
    ...
    <div class="category-topic-last"><?=avatar($t['last_post_id']?$t['last_avatar']:$t['avatar_path'],$t['last_author']??$t['display_name']??'Учасник')?><div><span><?=e($t['last_author']??$t['display_name']??'Учасник')?></span>
