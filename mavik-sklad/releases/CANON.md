...
Будь-які R1–R213, R213-reload, їхні patch/bundle/backup/recovery/candidate/checkpoint-файли та інші попередні release artifacts:
...
- історичні згадки не мають жодного пріоритету над R214.
